...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var searchTotalPage = parseInt($('.paging_button.last a').eq(0).attr('index'));

        function loadPage(pageIndex) {
            var pageSize = parseInt($('div.paging').eq(0).attr('pageSize'));
        ...
        function GenPaging() {
            ...
            html += '<span class="next paging_button"><a href="javascript:void(0);">Next</a></span> <span class="last paging_button"><a href="javascript:void(0);" index="' + searchTotalPage + '">Last</a></span>';
