<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true"
    CodeBehind="KhenThuong.aspx.cs" Inherits="HutStaff.Administrator.Pages.TimKiem.KhenThuong" %>
            ...
            <div class="table-container">
                <asp:GridView ID="GridView1" runat="server" class="table-result" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Năm khen" DataField="nkt_qtkt" DataFormatString="{0:yyyy}" />
            ...
            <div class="form-container">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownlistHinhThucKhenThuong" Width="300px" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNamKhenThuong" Width="290px" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtLyDo" runat="server" Width="600px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
