...
<asp:Content runat="server" ID="content1" ContentPlaceHolderID="MainContentPlaceHolder">
    <div class="form-container" id="content">
        ...
        <table cellspacing="1" cellpadding="4" border="0" class="forumline report-table">
			<tbody>
                <tr>
					<th class="thHead" height="55" align="center" colspan="4">Thống kê thành tích khen thưởng</th>
				</tr>
				<tr>
				...
				<tr>
                    ...
                    <td valign="top" align="left" class="row2">
						<span class="p-title">Tình trạng hiện tại</span> <br/>		
				...
				<tr>
					<td align="center" colspan="4" class="row1">						
