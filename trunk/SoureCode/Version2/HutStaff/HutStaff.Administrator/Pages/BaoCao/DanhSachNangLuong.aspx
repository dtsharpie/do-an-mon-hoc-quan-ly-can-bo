                            ...
                            <table border="0" width="95%" cellspacing="1" cellpadding="4" class="forumline">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                <input type="checkbox" class="cbkitem" name="77" />
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                Viện Công nghệ Sinh học và Thực phẩm</p>
                                        </td>
                                        <td class="Row2">
                                            <p class="Text">
                                                15109</p>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                <input type="checkbox" class="cbkitem" name="1159">
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                <input type="checkbox" class="cbkitem" name="895">
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                <input type="checkbox" class="cbkitem" name="1761">
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                <input type="checkbox" class="cbkitem" name="1969">
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                <input type="checkbox" class="cbkitem" name="1502">
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                <input type="checkbox" class="cbkitem" name="969">
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                <input type="checkbox" class="cbkitem" name="1111">
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="Row1">
                                            <p class="Text">
                                                <input type="checkbox" class="cbkitem" name="968">
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
