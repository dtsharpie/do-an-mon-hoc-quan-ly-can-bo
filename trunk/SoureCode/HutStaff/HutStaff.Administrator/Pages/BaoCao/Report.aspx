    	...
    	<tbody>
            <tr>
                <th height="55" align="center" colspan="2" class="thHead">
                    Biểu phân loại cán bộ công chức theo ngạch, độ tuổi và giới tính
		        </th>
            </tr>
            <tr>
                <td height="30" align="center" class="Row2">Chọn đơn vị lập báo cáo</td>
                <td height="30" align="center" class="Row1">
		            <asp:DropDownList ID="ddlDonVi" size="1" runat="server">                    
	         ...
	         <tr>
		        ...
		        <td height="30" class="Row1">                                    		            
	                ...
	                <asp:CheckBox runat="server" value="16" ID="chkdcb17"/> Tuyển dụng 2011<br/>
