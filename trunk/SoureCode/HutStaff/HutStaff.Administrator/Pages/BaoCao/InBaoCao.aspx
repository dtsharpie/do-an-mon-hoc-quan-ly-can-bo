    ...
    <div class="content bao-cao">
        ...
        <div id="divQuanLy" class="main">
            <div class="row">
                ...
                <div class="row_text">
                    <a href="/Pages/QuanLy/BoSungCanBo.aspx">Báo cáo thống kê</a>
                    <p>
            ...
            <div class="row">
                ...
                <div class="row_text">
                    <a href="/Pages/QuanLy/ImportLuong.aspx">In bảng xét nâng lương hàng năm</a>
                    <p>
            ...
            <div class="row">
                <div class="row_logo">
                    <a href="/Pages/QuanLy/NguoiDung.aspx">
                        <img src="/images/baocao1.png" height="50" width="50"></a></div>
                <div class="row_text">
                    <a href="/Pages/QuanLy/NguoiDung.aspx">In danh sách khen thưởng</a>
                    <p>
