...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <br>
    <h1>Tìm kiếm thông tin cán bộ</h1>
    <hr width="800px">
    <form name="myform" action="./Search_files/Search.htm" method="post" autocomplete="off" onsubmit="return false">  
    <div id="timkiem">
    	<div class="hang">
        ...
        <div class="hang">
        	<h4>Mã cán bộ: </h4>
            <div class="row-right">
                <input type="text" name="macanbo" value="" onkeypress="return submitenter(this,event);" />
            </div>
        </div>
        <div class="hang">
        	<h4>Tên cán bộ: </h4>
            <div class="row-right">
                <input type="text" style="width:300px" name="hoten" id="hoten" value="Huỳnh Quyết Thắng" onkeypress="return submitenter(this,event);  "/>
            </div>
        </div>
        <div class="hang">
        	<h4>Giới tính:</h4>
            <div class="row-right">
        	    <input type="checkbox" name="gt_nam" value="1"> Nam
                <input type="checkbox" name="gt_nu" value="0">Nữ
            </div>
        </div>
      <div class="hang">
        	<h4>Tuổi:</h4>
             <div class="row-right">
        	    Từ <input type="text" style="width:30px" name="tuoi_lonhon" value="">
                Đến <input type="text" style="width:30px" name="tuoi_nhohon" value="">
            </div>
        </div>
        <div class="hang">
        	<h4>Diện cán bộ:</h4>
         ...
         <div class="hang">
          ...
          <div class="hang">
        	<h4>Năm về trường:</h4>
             <div class="row-right">
                <input type="text" style="width:40px" name="namvetruong" value=""/>  <font size="1"> <i> (Nhỏ nhất: 1956) </i></font>
        	</div>
        </div>
        <p align="center">
            <a href="http://localhost/qlcb2012/search_mr.php" style=" margin-left:500px;"><font size="+0.5">Trang tìm kiếm mở rộng</font></a>
        </p>
    </div>
    
    <input type="image" src="./Search_files/timkiem.png" style=" margin-left:650px;" onmousemove="{src=&quot;css/images/timkiem1.png&quot;}" onmouseout="{src=&quot;css/images/timkiem.png&quot;};" onclick="this.form.submit();"/>
...
<br><div align="left">&gt;&gt; Tìm thấy <b><font color="red">1</font></b> cán bộ  </div> 
                                        <a href="http://localhost/qlcb2012/select_fields_extract.php" target="_blank"> <font size="+1" color="#0033FF"><b>&nbsp;&nbsp;&nbsp;&nbsp;Xuất dữ liệu 
                                        </b></font></a>
                                        
                                        <a href="http://localhost/qlcb2012/insocai.php" target="_blank"> <font size="+1" color="#0033FF"><b>&nbsp;&nbsp;&nbsp;&nbsp;In sổ cái 
                                        </b></font></a>
                                                                                 <a href="mailto:thanghq-fit@mail.hut.edu.vn;" target="_blank"> <font size="+1" color="#0033FF"><b>&nbsp;&nbsp;&nbsp;&nbsp;Gửi email
                                        </b></font></a>
                                                                                <br> <table class="forumline" border="0" cellpadding="4" cellspacing="1" width="100%">
                        <tbody><tr style="border:none">
                            ...
                            <input type="hidden" name="totalofresult" value="1">
                            
                        </tr></tbody></table>                <div id="noidung">
                  <table width="100%">	<tbody><tr class="tieude">
							...
							<td>&nbsp;&nbsp;Điện thoại</td>
							<td>&nbsp;&nbsp;Email</td><td>Xóa</td> </tr><tr>
					
                                <td width="20px" align="center">
                                &nbsp;1</td>
                                <td width="230"><b><a href="javascript:viewinfor(699);" onmousemove="mOvr();" onmouseout="mOut();" class="readlink">&nbsp;Huỳnh Quyết Thắng</a></b></td>
                                <td width="70px">&nbsp;002.005.00398</td>
                                <td width="230px">&nbsp;Bm Công nghệ phần mềm</td>	
								
								<td width="50px" class="rong">&nbsp;0913536752</td>
                                <td width="100px" class="rong">&nbsp;thanghq-fit@mail.hut.edu.vn</td>	<td class="xoa" align="center"> <a href="http://localhost/qlcb2012/huyhoso.php?sh=699">Xóa</a></td>  </tr><tr><td>&nbsp;</td></tr></tbody></table>       
    </div>
