<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="QLCB_BK.Xemthongtin.Login" %>
        ...
        <div id="divLogin">
            <div id="divSwitch">
                <a id="lnkAdminPage" href="/Login.aspx" class="lnkSwitchButton left">
                    <img src="/Images/tql.png" alt="trang_quan_ly" /></a>
                <a id="lnkViewPage" href="javascript:void(0);" class="lnkSwitchButton left">
                    <img src="/Images/xtt2.png" alt="trang_xem_thong_tin" /></a>
            </div>
            <div id="divLoginTitle1"></div>
            ...
            <a href="javascript:void(0);" runat="server" id="lnkLogin" />
