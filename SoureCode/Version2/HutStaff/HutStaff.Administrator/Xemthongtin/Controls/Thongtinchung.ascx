        ...
        <ItemTemplate>
            <table class="table-result">
                ...
                <tr class="even">
                    ...
                    <td>
                        <label>
                            Hôn nhân:<span><%# Eval("honnhan")%></span>
                        </label>
                    </td>
                    <td>
                        <label>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            Ngày cấp:<input id="ngay_cap" class="datepicker" value="<%# Eval("ngay_cap") == DBNull.Value ? "" : Convert.ToDateTime(Eval("ngay_cap")).ToString("dd/MM/yyyy")%>"
