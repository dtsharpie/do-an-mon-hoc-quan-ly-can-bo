...
{
    public partial class ChucVuDang : System.Web.UI.Page
    {
        protected int iShcc;
        ...
        protected void Bind()
        {
            ...
            DataTable tblData = BO.Thongtinchung.Thongtinchung.GetCongTacDangByID(iShcc);
            ...
            DataTable allchucvu = BO.Thongtinchung.Thongtinchung.GetAllChucVuDang();
            DropDownListChucVu.DataSource = allchucvu;
            DropDownListChucVu.DataTextField = "cud";
            DropDownListChucVu.DataValueField = "ma_cud";
        ...
        protected void saveButtonClick(object sender, EventArgs e)
        {
            ...
            {
                BO.Thongtinchung.Thongtinchung.InsertChuVuDangDoan(Int32.Parse(ViewState["ishcc"].ToString()), Int32.Parse(DropDownListChucVu.SelectedValue.ToString()), ngaythangBD,ngaythangKT,txtThongTinKhac.Text,2);
                
            }
            if (saveButton.Text == "Cập nhật")
            {

                BO.Thongtinchung.Thongtinchung.UpdateChuVuDangDoan(Int32.Parse(ViewState["id"].ToString()), Int32.Parse(DropDownListChucVu.SelectedValue.ToString()), ngaythangBD, ngaythangKT, txtThongTinKhac.Text, 2);
