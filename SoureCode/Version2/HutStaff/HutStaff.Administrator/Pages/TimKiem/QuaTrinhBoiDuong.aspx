<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true"
    CodeBehind="QuaTrinhBoiDuong.aspx.cs" Inherits="HutStaff.Administrator.Pages.TimKiem.QuaTrinhBoiDuong" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $('#divSideBar ul > li > a').eq(12).addClass('active');
        });
    </script>
</asp:Content>
            ...
            <div class="form-container">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNoiBoiDuong" Width="200px" runat="server" />
                        </td>
                        <td>
                            Nội dung bồi dưỡng
                        </td>
                        <td>
                            <asp:TextBox ID="txtNoiDungBoiDuong" Width="200px" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListVanBang" Width="210px" runat="server" />
                        </td>
                        <td>
                            Hình thức bồi dưỡng
                        </td>
                        <td>
                            <asp:DropDownList ID="DropDownListHinhThucBoiDuong" Width="210px" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
