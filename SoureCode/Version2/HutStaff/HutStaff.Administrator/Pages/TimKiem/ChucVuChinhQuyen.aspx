<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true"
    CodeBehind="ChucVuChinhQuyen.aspx.cs" Inherits="HutStaff.Administrator.Pages.TimKiem.ChucVuChinhQuyen" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $('#divSideBar ul > li > a').eq(3).addClass('active');
        });
    </script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div>
        ...
        <div class="table-container">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table-result"
                OnRowDeleting="Gridview1Deleting" OnSelectedIndexChanged="GridView1Changed">
                <Columns>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;<input type="checkbox" runat="server" id="checkBoxDennay" />
                        Đến nay
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownListBoSungDuLieuChucVu" Width="360px" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="saveButton" runat="server" Text="Ghi nhận" CssClass="button" OnClick="saveButtonClick" />
                        <asp:Button ID="resetButton" runat="server" Text="Làm lại" CssClass="button" OnClick="resetButtonClick" />
                    </td>
                </tr>
            </table>
        </div>
