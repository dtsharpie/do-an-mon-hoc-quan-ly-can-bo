<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true"
    CodeBehind="DienBienLuong.aspx.cs" Inherits="HutStaff.Administrator.Pages.TimKiem.DienBienLuong" %>
            ...
            <div class="form-container">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownlistNgach" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownlistBacLuong" Width="60px" runat="server">
