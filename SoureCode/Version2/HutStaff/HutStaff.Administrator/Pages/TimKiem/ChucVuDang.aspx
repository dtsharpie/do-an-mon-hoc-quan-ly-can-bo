<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true" CodeBehind="ChucVuDang.aspx.cs" Inherits="HutStaff.Administrator.Pages.TimKiem.ChucVuDang" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    $(document).ready(function () {
        $('#divSideBar ul > li > a').eq(4).addClass('active');
    });
</script>
</asp:Content>
