<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true"
    CodeBehind="CacChucDanh.aspx.cs" Inherits="HutStaff.Administrator.Pages.TimKiem.CacChucDanh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $('#divSideBar ul > li > a').eq(2).addClass('active');
        });
    </script>
</asp:Content>
        ...
        <div class="divInfo" style="margin-top: 10px;">
            ...
            <div class="table-container">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table-result"
                    OnRowDeleting="deleteData" OnSelectedIndexChanged="updateData">
                    <Columns>
                        <asp:BoundField DataField="id" />
                        <asp:BoundField HeaderText="Chức danh" DataField="dhdp" />
                        <asp:BoundField HeaderText="Ngày tháng phong" DataField="ntnpdh" DataFormatString="{0:dd/MM/yyyy}" />
            ...
            <div class="form-container">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="cacchudanhdownList" Width="198px" runat="server">
                            </asp:DropDownList>
                            &nbsp;Chức danh cao nhất
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            /
                            <asp:TextBox ID="txtNamBoNhiem" Width="80px" runat="server"></asp:TextBox>
                            &nbsp;(ngày/tháng/năm)
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="thongtinkhacTextBox" runat="server" Width="600px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
