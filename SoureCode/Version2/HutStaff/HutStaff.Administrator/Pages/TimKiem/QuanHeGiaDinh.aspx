<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true"
    CodeBehind="QuanHeGiaDinh.aspx.cs" Inherits="HutStaff.Administrator.Pages.TimKiem.QuanHeGiaDinh" %>
            ...
            <div class="form-container">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtHoVaTen" Width="250px" runat="server"></asp:TextBox>
                        </td>
                        <td class="title">
                            Quan hệ
                        </td>
                        <td>
                            <asp:DropDownList ID="DropDownlistQuanHe" Width="260px" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNgheNghiep" Width="250px" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            Chức vụ
                        </td>
                        <td>
                            <asp:TextBox ID="txtChucVu" Width="250px" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtNoiCongTac" Width="250px" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            Quốc tịch
                        </td>
                        <td>
                            <asp:DropDownList ID="DropdownListQuocTich" Width="260px" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropdownListNoiDinhCu" Width="260px" runat="server">
                            </asp:DropDownList>
                        </td>
                        <td>
                            Chỗ ở hiện nay
                        ...
                        <td>
                            <asp:TextBox ID="txtChoOHienNay" Width="250px" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="txtThongTinKhac" Width="600px" runat="server" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
