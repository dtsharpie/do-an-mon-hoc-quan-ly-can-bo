<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true"
    CodeBehind="KyLuat.aspx.cs" Inherits="HutStaff.Administrator.Pages.TimKiem.KyLuat" %>
            ...
            <div class="form-container">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownlistHinhThucKyLuat" Width="200px" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNamKyLuat" Width="190px" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="title">
                        ...
                        <td>
                            <asp:TextBox ID="txtNamXoaKyLuat" Width="190px" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
